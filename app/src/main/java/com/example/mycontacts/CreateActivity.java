...
public class CreateActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    DbHelper dbHelper;
    private EditText edtName, edtPhoneNumber, edtEmail, edtAddress, edtSocialMedia;
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    dbHelper.store(name, phone_number, email, bytes, status, address, sosmed, social_media);

                    Toast.makeText(getApplicationContext(), "Contact created successfully.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CreateActivity.this, com.example.mycontacts.MainActivity.class);
    ...
    public boolean validatePhoneNumber(String phoneNumber) {
        ...
        if (phoneNumber.isEmpty()) {
            ...
            return false;
        }else if(!phoneNumber.matches("^(06)[0-9]{8}$")){
