...
public class EditActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    ...
    private EditText etName, etPhone, etEmail, etAddress, etSocialMedia;
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    dbHelper.update(id, name, phone_number, email, imageBytes, status, address, sosmed, social_media);
                    Toast.makeText(getApplicationContext(), "Contact updated successfully.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(EditActivity.this, com.example.mycontacts.MainActivity.class);
